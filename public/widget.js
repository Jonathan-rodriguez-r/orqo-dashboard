...
(function () {
  ...
  style.textContent += "\n#orqo-widget, #orqo-widget * , #orqo-widget *::before, #orqo-widget *::after { box-sizing: border-box; }\n#orqo-widget button, #orqo-widget input, #orqo-widget textarea, #orqo-widget select { font: inherit; letter-spacing: inherit; text-transform: none; }\n#orqo-widget button { margin: 0; }\n#orqo-widget img, #orqo-widget svg { display: block; max-width: none; flex-shrink: 0; }\n#orqo-widget a { text-decoration: none; }\n#orqo-widget .w-header { gap: 0.75rem; }\n#orqo-widget .w-hd-left { flex: 1 1 auto; min-width: 0; }\n#orqo-widget .w-brand { white-space: nowrap; line-height: 1; }\n#orqo-widget .w-online { white-space: nowrap; flex-shrink: 0; }\n#orqo-widget .w-hd-right { display: flex; align-items: center; gap: 0.2rem; margin-left: auto; flex: 0 0 auto; }\n#orqo-widget .w-hbtn { flex: 0 0 28px; padding: 0; }\n#orqo-widget .w-powered { flex-shrink: 0; padding: 0.18rem 0 0.42rem; background: var(--g02); text-align: center; font-family: var(--f-body); font-size: 0.66rem; line-height: 1; color: rgba(233,237,233,0.24); }\n#orqo-widget .w-powered a { color: inherit; opacity: 0.95; }\n#orqo-widget[data-theme=\"light\"] .w-powered { color: rgba(21,32,24,0.34); }\n";
