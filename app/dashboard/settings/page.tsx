...
export default function SettingsPage() {
  ...
  return (
    <div className="dash-content">
      ...
      {/* â”€â”€ Account tab â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {tab === 'account' && (
        <div className="grid-2">
          <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            <div className="card">
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                <div style={{ width: 44, height: 44, borderRadius: 'var(--radius-sm)', background: 'var(--acc-g)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>âš¡</div>
                <div>
              ...
              <a href="https://orqo.io/#pricing" target="_blank" rel="noopener" className="btn btn-ghost btn-sm" style={{ width: '100%', justifyContent: 'center' }}>Ver planes â†’</a>
            </div>
            <div className="card">
              <div className="card-title">Soporte</div>
              <p style={{ fontSize: 13, color: 'var(--g05)', marginBottom: 12 }}>Â¿Tienes dudas o problemas? El equipo de ORQO estÃ¡ disponible para ayudarte.</p>
              <a href="mailto:hello@orqo.io" className="btn btn-ghost btn-sm">âœ‰ hello@orqo.io</a>
              <a href="https://wa.me/573013211669" target="_blank" rel="noopener" className="btn btn-ghost btn-sm" style={{ marginLeft: 8 }}>ðŸ’¬ WhatsApp</a>
            </div>
          </div>
        </div>
      )}
